                ...
                <main className="pt-16 p-6">
                    ...
                    <div className="bg-white p-6 rounded-lg shadow">
                        <div className="grid grid-cols-2 gap-4">
                            <div><p><strong>Batch ID:</strong> {produksi.batch_id}</p></div>
                            <div><p><strong>Nama Obat:</strong> {produksi.nama_obat}</p></div>
                            <div><p><strong>Jumlah:</strong> {produksi.jumlah}</p></div>
                            <div><p><strong>Status:</strong> {produksi.status}</p></div>
                        </div>
                        <div className="mt-6 border-t pt-6">
                            ...
                            {qrCode && (
                                <div className="mt-6 text-center p-4 border rounded-lg">
                                    ...
                                    <p className="text-xs text-gray-500 mt-2">Cetak dan tempelkan QR Code ini pada kemasan obat.</p>
                                </div>
                            )}
                        </div>
                    </div>
