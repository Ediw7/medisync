...
# Tujuan: Admin Produsen (Org1) menyetujui definisi chaincode.
# Cara Menjalankan: ./scripts/1_approve_produsen.sh
# =================================================================
#!/bin/bash
set -e
...
export PACKAGE_ID=$(cat scripts/package.id) # Baca package ID dari file
